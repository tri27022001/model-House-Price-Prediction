...
def visualize(y_test,y_pred):
    ...
    plt.title("Actual vs. Predicted House Prices - HuberRegression")
    plt.legend()
    plt.grid(True)
    fname = "HuberRegression.png"
...
model_filename = 'huber_model.pkl'
joblib.dump(huber_model, model_filename)
...
new_price = huber_model.predict(new_house_scaled)

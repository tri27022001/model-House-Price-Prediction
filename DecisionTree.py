...
def visualize(y_test,y_pred):
    ...
    plt.title("Actual vs. Predicted House Prices - DecisionTree")
    plt.legend()
    plt.grid(True)
    fname = "DecisionTree.png"
...
new_house = [[2, 19, 2018, 20, 20, 21, 59.8058084,  , 2661, 1, 8, 10, 3, 82.6, 10.8, 1]]

# Chuẩn hóa dữ liệu căn nhà mới
new_house_scaled = scaler.transform(new_house)

# Dự đoán giá nhà cho căn nhà mới từ tập dữ liệu
new_price = DT_model.predict(new_house_scaled)
